...
- **Benchmark:** Use `tests/useTimelineData.test.js` and Playwright visual snapshots as baseline metrics.
...
- **Validation:** Always verify with `npm run build` and Playwright visual checks.
