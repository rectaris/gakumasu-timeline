...
- 開いた詳細パネルには、Escape キーまたは外側のクリック / タップで閉じられる案内が表示されます
...
- 画面下部の**表示期間ボタン**で、水平ズームアウト・ズームイン・全体表示ができます
- 詳細パネルを開いたままでも、画面下部の**表示期間 / レーン密度ボタン**でズーム操作を続けられます
- タイムライン上でホイールするとカーソル位置基準で**表示期間**を拡大縮小できます
- `Ctrl` を押しながらホイールすると、**レーン密度**を調整できます
- 横方向ホイールでは水平方向に移動します
...
- 画面下部の**レーン密度ボタン**で、縦方向のレーン密度を調整できます
...
- 案内カードでは、画面下部の **表示期間 / レーン密度** 操作から範囲調整できることも案内されます
