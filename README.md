...
- 右上の**表示期間ボタン**で、水平ズームアウト・ズームイン・全体表示ができます
- 詳細パネルを開いたままでも、右上の**表示期間 / レーン密度ボタン**でズーム操作を続けられます
...
- 右上の**レーン密度ボタン**で、縦方向のレーン密度を調整できます
...
- 案内カードでは、右上の **表示期間 / レーン密度** 操作から範囲調整できることも案内されます
